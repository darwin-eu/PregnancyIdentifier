...
row per pregnancy episode: `person_id`, `inferred_episode_start`,
`inferred_episode_end`, `final_outcome_category`, `precision_days`, and
other QA/concordance columns. Load it for cohort definition, export, or
further analysis.
