...
## `mergeHipps()`: merge HIP + PPS into unified HIPPS episodes

`mergeHipps()` combines the outputs of HIP (outcome-anchored episodes) and PPS (timing-anchored episodes) into a single standardized episode table. It:
