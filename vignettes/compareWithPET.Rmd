...
exportDir    <- file.path(tempdir(), "pet_vignette_comparison")
...
# 3) Run the PET comparison (writes summarised result and log to exportDir; returns nothing)
...
res <- omopgenerics::importSummarisedResult(file.path(exportDir, "pet_comparison_summarised_result.csv"))
```
