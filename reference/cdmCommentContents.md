...
Flattens a CDM using \[CDMConnector::cdmFlatten()\], collects the data
...
- personIds:
  ...
  Optional numeric vector of \`person_id\` values to filter on. If
  \`NULL\`, all persons in the flattened CDM are used (use with care).
