...
[![Tests (SQLServer)](https://github.com/darwin-eu/PregnancyIdentifier/actions/workflows/test-sqlserver.yaml/badge.svg)](https://github.com/darwin-eu/PregnancyIdentifier/actions/workflows/test-sqlserver.yaml)
...
**Use the result:**  
`pregnancy_output/final_pregnancy_episodes.rds` is a data frame with one row per pregnancy episode: `person_id`, `final_episode_start_date`, `final_episode_end_date`, `final_outcome_category`, `esd_precision_days`, and other esd_* QA/concordance columns. Load it for cohort definition, export, or further analysis.
