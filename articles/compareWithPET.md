...
#> INFO  [2026-06-09 13:12:48] [export] START  snapshot(cdm) [DB]
#> INFO  [2026-06-09 13:12:48] [export] DONE   snapshot(cdm) [DB] (0.2 s)
#> INFO  [2026-06-09 13:12:48] [export] START  readRDS(final_pregnancy_episodes.rds)
#> INFO  [2026-06-09 13:12:48] [export] DONE   readRDS(final_pregnancy_episodes.rds) (0.0 s)
#> INFO  [2026-06-09 13:12:48] [export] episodes loaded: 37 rows, 45 columns
#> INFO  [2026-06-09 13:12:48] [export] START  copy raw artifacts
#> INFO  [2026-06-09 13:12:48] [export] DONE   copy raw artifacts (0.0 s)
#> INFO  [2026-06-09 13:12:48] [export] START  exportAgeSummary [DB]
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportAgeSummary [DB] (0.3 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportPrecisionDays
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportPrecisionDays (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportPrecisionDaysDenominators
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportPrecisionDaysDenominators (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportEpisodeFrequency
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportEpisodeFrequency (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportPregnancyFrequency
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportPregnancyFrequency (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportEpisodeFrequencySummary
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportEpisodeFrequencySummary (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportGestationalAgeSummary
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportGestationalAgeSummary (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportGestationalAgeCounts
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportGestationalAgeCounts (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportGestationalWeeksCounts
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportGestationalWeeksCounts (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportGestationalDurationCounts
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportGestationalDurationCounts (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportTimeTrends
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportTimeTrends (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportObservationPeriodRange [DB]
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportObservationPeriodRange [DB] (0.1 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportPregnancyOverlapCounts
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportPregnancyOverlapCounts (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportMissingDates
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportMissingDates (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportReversedDatesCounts
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportReversedDatesCounts (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportOutcomeCategoriesCounts
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportOutcomeCategoriesCounts (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportDeliveryModeSummary
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportDeliveryModeSummary (0.0 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportConceptTimingCheck [DB]
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportConceptTimingCheck [DB] (0.1 s)
#> INFO  [2026-06-09 13:12:49] [export] START  exportCleanupQualityCheck
#> INFO  [2026-06-09 13:12:49] [export] DONE   exportCleanupQualityCheck (0.1 s)
#> INFO  [2026-06-09 13:12:49] [export] ALL STEPS COMPLETE -> /tmp/RtmplV0aix/pet_vignette_pipeline/export
```
...
Episode counts: algorithm vs PET {.table}
...
Protocol summary (for reporting) {.table}
...
Venn counts (one-to-one matching) {.table}
...
2×2 confusion matrix (PET = reference) {.table}
...
Sensitivity, specificity, PPV, NPV {.table}
...
Date difference summary (PET − algorithm, days) {.table}
...
Date differences by algorithm outcome (PET − algorithm, days) {.table}
...
Outcome accuracy (matched pairs) {.table}
...
Outcome by year (same-year pairs) {.table}
...
Pregnancy duration (days) by source {.table}
...
Duration (matched pairs only) {.table}
